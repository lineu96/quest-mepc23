...
table1 <- freq_n_ord(quest_23$instituicao)
table2 <- freq_ord(quest_23$instituicao)
...
table2 <- freq_n_ord(quest_23$instituicao)
...
compara <- rbind(freq_n_ord(quest_23$instituicao),
...
table1 <- freq_ord(quest_23$setor_ufpr)

table2 <- freq_ord(subset(quest_23, quest_23$instituicao == 'ufpr')$setor_ufpr)
...
table2 <- freq_n_ord(subset(quest_23, quest_23$instituicao == 'ufpr')$setor_ufpr)
...
table1 <- freq_n_ord(quest_23$atividade_ies)
...
table1 <- freq_ord(quest_23$atividade_ies)
...
compara <- rbind(freq_ord(quest_23$atividade_ies),
...
table1 <- freq_ord(quest_23$area_conhec)
```
...
table1 <- freq_n_ord(quest_23$area_conhec)
...
```{r, comment=FALSE, message=FALSE, fig.align='center', warning=TRUE, echo = FALSE}
compara <- rbind(freq_n_ord(quest_23$area_conhec),
...
compara$Ano <- c(rep('2023',3), rep('2022',3), 
...
<center>
```{r, comment=FALSE, message=FALSE, fig.align='center', warning=TRUE, echo = FALSE}
fim_grad <- subset(quest_23, fim_grad<2021 & fim_grad>1950)
...
```{r, comment=FALSE, message=FALSE, fig.align='center', warning=TRUE, echo = FALSE, warning=FALSE, fig.width=15}
...
<center>
```{r, comment=FALSE, message=FALSE, fig.align='center', warning=TRUE, echo = FALSE}
table1 <- freq_ord(quest_23$inst_grad)
...
# tratamento
quest_23$programas_grad <- tolower(iconv(quest_23$programas_grad, 
                                   to ='ASCII//TRANSLIT', 
                                   from = "UTF-8"))

quest_23$programas_grad <- gsub(",",";",quest_23$programas_grad)
...
<center>
```{r, comment=FALSE, message=FALSE, fig.align='center', warning=TRUE, echo = FALSE}
table1 <- freq_ord(quest_23$inst_msc)
...
table1 <- freq_ord(subset(quest_23, final_msc <= 2022)$inst_msc)
...
artigos <- subset(quest_23, artigos >= 0)
...
table1 <- freq_ord(quest_23$bolsa)
...
```{r, comment=FALSE, message=FALSE, fig.align='center', warning=TRUE, echo = FALSE, fig.height=8}
table1 <- freq_n_ord(quest_23$bolsa)
...
materias_est <- subset(quest_23, materias_est >= 0)
...
```{r, comment=FALSE, message=FALSE, fig.align='center', warning=TRUE, echo = FALSE, warning=FALSE}
ggplot(materias_est, aes(x=materias_est)) +
  geom_histogram(col=1,
                 lwd=1,
                 breaks = hist(materias_est$materias_est, plot = FALSE)$breaks) +
  xlab("Número de disciplinas") +
  ylab("Frequência") +
  ggtitle("Disciplinas de Estatística cursadas")+
  theme_classic() + theme(legend.position = 'none',
...
```{r, comment=FALSE, message=FALSE, fig.align='center', warning=TRUE, echo = FALSE, warning=FALSE}
ggplot(data = materias_est, 
       mapping = aes(y=materias_est, x='1')) +
  stat_boxplot(geom ='errorbar')+
  geom_boxplot(alpha = 1)+
  stat_summary(fun.y=mean, 
               geom="point", 
...
```{r, comment=FALSE, message=FALSE, fig.align='center', warning=TRUE, echo = FALSE, warning=FALSE}
ggplot(materias_est) + 
  geom_histogram(aes(x=materias_est,
                     y=..density..), 
                 position="identity",
                 col = 1,
                 lwd = 1,
                 breaks = hist(materias_est$materias_est, plot = FALSE)$breaks) + 
  geom_density(aes(x=materias_est,
                   y=..density..),
               col = 4,
               lwd = 1) + 
  xlab("Número de disciplinas") +
...
```{r, comment=FALSE, message=FALSE, fig.align='center', warning=TRUE, echo = FALSE, warning=FALSE}
p1 = ggplot(materias_est, aes(x=materias_est)) +
  geom_histogram(col=1,
                 lwd=1,
                 breaks = hist(materias_est$materias_est, plot = FALSE)$breaks) + 
  ylab("Frequência") +
...
p1 = ggplot(materias_est) + 
  ...
  ylab("Densidade") +
  xlab("") +
  ggtitle("Número de disciplinas de Estatística cursadas")+
  theme_classic() + theme(legend.position = 'none',
                          plot.title = element_text(family = "Helvetica", 
                                                    face = "bold", 
                                                    size = (20),
...
materias_est_23 <- subset(quest_23,materias_est>=0)
materias_est_22 <- subset(quest_22,materias_est>=0)
materias_est_21 <- subset(quest_21,materias_est>=0)
materias_est_20 <- subset(quest_20,td_estatGrad>=0)
materias_est_19 <- subset(quest_19,td_estatGrad>=0)

materias_est <- data.frame(
  materias_est = c(materias_est_19$td_estatGrad,
                   materias_est_20$td_estatGrad,
                   materias_est_21$materias_est,
                   materias_est_22$materias_est,
                   materias_est_23$materias_est),
  ano = c(rep(2019,nrow(materias_est_19)),
          rep(2020,nrow(materias_est_20)),
          rep(2021,nrow(materias_est_21)),
          rep(2022,nrow(materias_est_22)),
          rep(2022,nrow(materias_est_23))
          ))

ggplot(materias_est) + 
  geom_bar(aes(x=materias_est), 
                 position="identity",
                 col = 1,
                 lwd = 1) + 
  ylab("Densidade") +
...
### Quantas disciplinas de Estatística vc cursou na pós-graduação (mestrado + doutorado) no total?  {.tabset .tabset-fade .tabset-pills}
...
materias_est_pos <- subset(quest_23, materias_est_pos >= 0)

pander(tab_classes(materias_est_pos$materias_est_pos))
```
</center>
...
<center>
```{r, comment=FALSE, message=FALSE, fig.align='center', warning=TRUE, echo = FALSE}
pander(posicao(materias_est_pos$materias_est_pos))
pander(dispersao(materias_est_pos$materias_est_pos))
```
</center>
...
```{r, comment=FALSE, message=FALSE, fig.align='center', warning=TRUE, echo = FALSE, warning=FALSE}
table <- as.data.frame(table(materias_est_pos$materias_est_pos))
table$Var1 <- as.numeric(as.vector(table$Var1))
...
ggplot(table, aes(x=Var1, y=Freq)) +
  ...
  xlab("Número de disciplinas") +
  ylab("Frequência") +
  ggtitle("Disciplinas diferentes de Estatística")+
  theme_classic() + theme(legend.position = 'none',
                          plot.title = element_text(family = "Helvetica", 
                                                    face = "bold", 
                                                    size = (20),
...
```{r, comment=FALSE, message=FALSE, fig.align='center', warning=TRUE, echo = FALSE, warning=FALSE}
ggplot(materias_est_pos, aes(x=materias_est_pos)) +
  geom_histogram(col=1,
                 lwd=1,
                 breaks = hist(materias_est_pos$materias_est_pos, plot = FALSE)$breaks) + 
  xlab("Número de disciplinas") +
  ylab("Frequência") +
  ggtitle("Disciplinas diferentes de Estatística")+
  theme_classic() + theme(legend.position = 'none',
...
```{r, comment=FALSE, message=FALSE, fig.align='center', warning=TRUE, echo = FALSE, warning=FALSE}
ggplot(data = materias_est_pos, 
       mapping = aes(y=materias_est_pos, x='1')) +
  stat_boxplot(geom ='errorbar')+
  geom_boxplot(alpha = 1)+
  stat_summary(fun.y=mean, 
               geom="point", 
...
```{r, comment=FALSE, message=FALSE, fig.align='center', warning=TRUE, echo = FALSE, warning=FALSE}
ggplot(materias_est_pos) + 
  geom_histogram(aes(x=materias_est_pos,
                     y=..density..), 
                 position="identity",
                 col = 1,
                 lwd = 1,
                 breaks = hist(materias_est_pos$materias_est_pos, plot = FALSE)$breaks) + 
  geom_density(aes(x=materias_est_pos,
                   y=..density..),
               col = 4,
               lwd = 1) + 
  xlab("Número de disciplinas") +
...
```{r, comment=FALSE, message=FALSE, fig.align='center', warning=TRUE, echo = FALSE, warning=FALSE}
p1 = ggplot(materias_est_pos, aes(x=materias_est_pos)) +
  geom_histogram(col=1,
                 lwd=1,
                 breaks = hist(materias_est_pos$materias_est_pos, plot = FALSE)$breaks) + 
  ylab("Frequência") +
...
p2 = ggplot(data = materias_est_pos, 
            mapping = aes(y=materias_est_pos, x='1')) +
  stat_boxplot(geom ='errorbar')+
  geom_boxplot(alpha = 1)+
  stat_summary(fun.y=mean, 
...
p1 = ggplot(materias_est_pos) + 
  ...
  ylab("Densidade") +
  xlab("") +
  ggtitle("Número de disciplinas diferentes de Estatística")+
  theme_classic() + theme(legend.position = 'none',
                          plot.title = element_text(family = "Helvetica", 
                                                    face = "bold", 
                                                    size = (20),
...
table1 <- freq_ord(quest_23$met_est)
...
table1 <- freq_n_ord(quest_23$met_est)
...
import_met_est <- subset(quest_23, import_met_est >= 0)
...
table1 <- freq_ord(quest_23$expectativa_pos_pg)
```
...
table1 <- freq_n_ord(quest_23$expectativa_pos_pg)
...
```{r, comment=FALSE, message=FALSE, fig.align='center', warning=TRUE, echo = FALSE}
compara <- rbind(freq_n_ord(quest_23$expectativa_pos_pg),
...
table1 <- freq_ord(quest_23$conhec_trans)
```
...
table1 <- freq_n_ord(quest_23$conhec_trans)
...
```{r, comment=FALSE, message=FALSE, fig.align='center', warning=TRUE, echo = FALSE}
compara <- rbind(freq_n_ord(quest_23$conhec_trans),
...
## 2023
quest_23$youtube <- tolower(iconv(quest_23$youtube,
                                      to ='ASCII//TRANSLIT', 
                                      from = "UTF-8"))

quest_23$youtube <- factor(quest_23$youtube, 
                               levels = tolower(c("sim", "nao")))

#----------------------------------------------------------------------

## 2022
quest_22$youtube <- tolower(iconv(quest_22$youtube,
                                      to ='ASCII//TRANSLIT', 
                                      from = "UTF-8"))

quest_22$youtube <- factor(quest_22$youtube, 
                               levels = tolower(c("sim", "nao")))
...
table1 <- freq_ord(quest_23$youtube)
```
...
```{r, comment=FALSE, message=FALSE, fig.align='center', warning=TRUE, echo = FALSE}
compara <- rbind(freq_ord(quest_23$youtube),
                 freq_ord(quest_22$youtube),
                 freq_ord(quest_21$youtube),
...
table1 <- freq_ord(quest_23$contat_coord)
```
...
```{r, comment=FALSE, message=FALSE, fig.align='center', warning=TRUE, echo = FALSE}
compara <- rbind(freq_ord(quest_23$contat_coord),
...
table1 <- freq_ord(quest_23$contat_colab)
```
...
```{r, comment=FALSE, message=FALSE, fig.align='center', warning=TRUE, echo = FALSE}
compara <- rbind(freq_ord(quest_23$contat_colab),
...
```{r, comment=FALSE, message=FALSE, fig.align='center', warning=TRUE, echo = FALSE}
compara <- rbind(freq_n_ord(quest_23$ensino_medio1),
...
```{r, comment=FALSE, message=FALSE, fig.align='center', warning=TRUE, echo = FALSE}
compara <- rbind(freq_n_ord(quest_23$ensino_medio2),
