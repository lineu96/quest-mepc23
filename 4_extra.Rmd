...
<center>
<table><tr>
<td> <img src="img/lineu1.jpg" alt="Drawing" style="width: 250px;"/>
<figcaption>Foto 1</figcaption></td>
<td> <img src="img/lineu2.jpg" alt="Drawing" style="width: 250px;"/>
...
quest_23$indica_foto <- c(rep('S/ barba', 50), #50 
                          rep('C/ barba', 50), #100
                          rep('S/ barba', 50), #150
                          rep('C/ barba', 50), #200
                          rep('S/ barba', 50), #250 
...
idade_foto <- subset(quest_23, idade_foto >= 18 & idade_foto <= 60)
...
compara <- rbind(freq_n_ord(quest_23$kiki_bouba),
