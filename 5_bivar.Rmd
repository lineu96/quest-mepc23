...
temp <- data.frame(emprego = quest_23$emprego,
                   expectativa = quest_23$expectativa_pos_pg)
...
table2 <- as.matrix(prop.table(table(quest_23$expectativa_pos_pg,
                                     quest_23$emprego), 
                               mar = 2))
...
```{r, comment=FALSE, message=FALSE, fig.align='center', warning=TRUE, echo = FALSE, warning=FALSE, fig.width=10}
ggplot(data = subset(quest_23, idade_foto>18 & idade_foto<50), 
       mapping = aes(x = sexo,
                     y=idade_foto)) +
  stat_boxplot(geom ='errorbar')+
  geom_boxplot(alpha = 1,
...
```{r, comment=FALSE, message=FALSE, fig.align='center', warning=TRUE, echo = FALSE, warning=FALSE, fig.width=10}
ggplot(data = subset(quest_23, tempo_ies >=0 & 
                       tempo_ies <=100 & 
                       app_transporte >=0 & 
                       app_transporte <=100), 
