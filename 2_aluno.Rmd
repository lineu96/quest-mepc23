...
```{r, comment=FALSE, message=FALSE, fig.align='center', warning=TRUE, echo = FALSE}
compara <- rbind(freq_n_ord(quest_23$sexo),
...
compara <- rbind(freq_n_ord(quest_23$emprego),
...
compara <- rbind(freq_n_ord(quest_23$residencia),
...
```{r, comment=FALSE, message=FALSE, fig.align='center', warning=TRUE, echo = FALSE, warning=FALSE, fig.height=12}
...
compara <- rbind(freq_n_ord(quest_23$origem),
...
compara <- rbind(freq_n_ord(quest_23$transporte),
...
app_transporte <- subset(quest_23, app_transporte >= 0 & app_transporte<=700)
...
app_transporte <- data.frame(app_transporte = c(app_transporte_19$td_qtddServTransp,
           ...
           ano = c(rep(2019,nrow(app_transporte_19)),
                   ...
                   rep(2022,nrow(app_transporte_23))
                   ))
